# NSIS package for ZABBIX x.x.x Client for Windows
# (C) 2006-2012 - Michel Manceron <michel.manceron@siemens.com>

#          
# Content / Purpose
# -----------------
To build an EXE install package for ZABBIX Agent x.x.x, using NSIS.
.\img\		: logs and pics
.\Include\	: nsh macros
...
# ---------------------------------------------------------
To install Zabbix agent and sender, just run zabbix_agent-x.x.x_installer.exe
...
#Since the the installer 1.6.1.0  
#------------------------------
...
# Credits
# -------
 . Vincent Besançon - initial NSIS package for ZABBIX 1.1.2 - Win32
