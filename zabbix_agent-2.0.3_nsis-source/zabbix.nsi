...
!define VER_PACK "2.0.3.0"
  ...
  VIAddVersionKey "FileDescription" "${NAME} Installer 32 and 64 bit"
...
Section "Zabbix Agent (required)" SEC01
  ...
  strcmp $OS64B '0' 0 x64Bitinst
    File ".\Installer\bin\zabbix_agentd.exe"
    goto s1
  x64Bitinst:
    File ".\Installer\bin\zabbix_agentd.exe"
  s1:
...
Section "Zabbix Sender (optional)" SEC02
  ...
  strcmp $OS64B '0' 0 x64Bitsend
    File ".\Installer\bin\zabbix_sender.exe"
    goto send1
  x64Bitsend:
    File ".\Installer\bin\zabbix_sender.exe"
  send1:
...
Section "Zabbix get (optional)" SEC03
  ...
  strcmp $OS64B '0' 0 x64Bitget
    File ".\Installer\bin\zabbix_get.exe"
    goto get1
  x64Bitget:
    File ".\Installer\bin\zabbix_get.exe"
  get1:
